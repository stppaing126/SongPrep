...
if __name__ == "__main__":
    st = 60
    et = 80
    wav, sr = load_track("/apdcephfs_fsgm/share_303204903/music_data/hunyuan/song_data/wyy2/WYY2/wangyiyun-115660-164702/云别-七星/云别-七星.flac", None, None)
    chunk = wav[..., st*sr:et*sr]
    ta.save("output.wav", chunk, sr)